...
- **Thinking**: English
- **Code**: English
- **Output**: English (Claude Code communicates with user in English)
...
Codex/Gemini I/O is logged to `.claude/logs/cli-tools.jsonl`.
Reference this log to review past consultations.

Session History is appended after running `/checkpointing`.
