...
- Node.js/TypeScript version requirements
...
- TypeScript support (built-in types, @types package)

## Common Patterns
- Recommended initialization patterns
- Error handling patterns
- Configuration best practices
- Testing approaches with Vitest/Jest
...
gemini -p "Research the library 'zod' comprehensively.
...
gemini -p "Research 'drizzle-orm' with focus on:
...
- When user says "research this library"
